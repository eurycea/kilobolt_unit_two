package com.palisade.kilobolt.constant;
...
public class Constants {
    ...
    public static final String RES_ENEMY_ONE_NORMAL = "heliboy.png";
    public static final String RES_ENEMY_ONE_ATTACKING = "heliboy.png";
    public static final String RES_ENEMY_ONE_JUMPING = "heliboy.png";
}
